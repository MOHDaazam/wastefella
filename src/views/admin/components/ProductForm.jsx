...
const ProductForm = ({ product, onSubmit, isLoading }) => {
  const [field, setField] = useState({
    ...
    partnerUrl: { value: product ? product.partnerUrl : '' },
  ...
  const onPartnerUrlInput = (e, value, error) => {
    setField({ ...field, partnerUrl: { value, error } });
  }
          ...
          <div className="d-flex">
            <div className="product-form-field">
              <Input
                label="Partner URL"
                readOnly={isLoading}
                placeholder="Paste partner product url"
                onInputChange={onPartnerUrlInput}
                isRequired={false}
                field="partnerUrl"
                type="text"
                value={field.partnerUrl.value}
              />
            </div>
          </div>
          <br />
